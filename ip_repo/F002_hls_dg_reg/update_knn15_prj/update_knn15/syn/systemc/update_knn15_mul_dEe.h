...
// ==============================================================
#ifndef __update_knn15_mul_dEe__HH__
#define __update_knn15_mul_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(update_knn15_mul_dEe) {
    ...
    SC_CTOR(update_knn15_mul_dEe):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
