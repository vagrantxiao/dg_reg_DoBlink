...
// ==============================================================
#ifndef __update_knn14_mul_cud__HH__
#define __update_knn14_mul_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(update_knn14_mul_cud) {
    ...
    SC_CTOR(update_knn14_mul_cud):  ACMP_mul_su_U ("ACMP_mul_su_U") {
