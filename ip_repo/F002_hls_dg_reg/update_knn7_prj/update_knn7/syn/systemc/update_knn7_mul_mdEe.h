...
// ==============================================================
#ifndef __update_knn7_mul_mdEe__HH__
#define __update_knn7_mul_mdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(update_knn7_mul_mdEe) {
    ...
    SC_CTOR(update_knn7_mul_mdEe):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
