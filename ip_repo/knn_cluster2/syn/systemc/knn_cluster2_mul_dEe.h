...
// ==============================================================
#ifndef __knn_cluster2_mul_dEe__HH__
#define __knn_cluster2_mul_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(knn_cluster2_mul_dEe) {
    ...
    SC_CTOR(knn_cluster2_mul_dEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
