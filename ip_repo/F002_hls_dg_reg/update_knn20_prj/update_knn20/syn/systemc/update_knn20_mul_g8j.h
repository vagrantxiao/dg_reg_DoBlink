...
// ==============================================================
#ifndef __update_knn20_mul_g8j__HH__
#define __update_knn20_mul_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(update_knn20_mul_g8j) {
    ...
    SC_CTOR(update_knn20_mul_g8j):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
