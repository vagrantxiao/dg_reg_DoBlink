...
// ==============================================================
#ifndef __update_knn3_mul_1cud__HH__
#define __update_knn3_mul_1cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(update_knn3_mul_1cud) {
    ...
    SC_CTOR(update_knn3_mul_1cud):  ACMP_mul_su_U ("ACMP_mul_su_U") {
