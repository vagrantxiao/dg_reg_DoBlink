...
architecture behav of knn_cluster1 is 
    ...
    signal update_knn1_U0_ap_start : STD_LOGIC;
    signal update_knn1_U0_ap_done : STD_LOGIC;
    signal update_knn1_U0_ap_continue : STD_LOGIC;
    signal update_knn1_U0_ap_idle : STD_LOGIC;
    signal update_knn1_U0_ap_ready : STD_LOGIC;
    signal update_knn1_U0_start_out : STD_LOGIC;
    signal update_knn1_U0_start_write : STD_LOGIC;
    signal update_knn1_U0_Input_1_V_V_ap_ack : STD_LOGIC;
    signal update_knn1_U0_Output_1_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal update_knn1_U0_Output_1_V_V_write : STD_LOGIC;
    signal update_knn2_U0_ap_start : STD_LOGIC;
    signal update_knn2_U0_ap_done : STD_LOGIC;
    signal update_knn2_U0_ap_continue : STD_LOGIC;
    signal update_knn2_U0_ap_idle : STD_LOGIC;
    signal update_knn2_U0_ap_ready : STD_LOGIC;
    signal update_knn2_U0_start_out : STD_LOGIC;
    signal update_knn2_U0_start_write : STD_LOGIC;
    signal update_knn2_U0_Input_1_V_V_read : STD_LOGIC;
    signal update_knn2_U0_Output_1_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal update_knn2_U0_Output_1_V_V_write : STD_LOGIC;
    signal update_knn3_U0_ap_start : STD_LOGIC;
    signal update_knn3_U0_ap_done : STD_LOGIC;
    signal update_knn3_U0_ap_continue : STD_LOGIC;
    signal update_knn3_U0_ap_idle : STD_LOGIC;
    signal update_knn3_U0_ap_ready : STD_LOGIC;
    signal update_knn3_U0_start_out : STD_LOGIC;
    signal update_knn3_U0_start_write : STD_LOGIC;
    signal update_knn3_U0_Input_1_V_V_read : STD_LOGIC;
    signal update_knn3_U0_Output_1_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal update_knn3_U0_Output_1_V_V_write : STD_LOGIC;
    signal update_knn4_U0_ap_start : STD_LOGIC;
    signal update_knn4_U0_ap_done : STD_LOGIC;
    signal update_knn4_U0_ap_continue : STD_LOGIC;
    signal update_knn4_U0_ap_idle : STD_LOGIC;
    signal update_knn4_U0_ap_ready : STD_LOGIC;
    signal update_knn4_U0_start_out : STD_LOGIC;
    signal update_knn4_U0_start_write : STD_LOGIC;
    signal update_knn4_U0_Input_1_V_V_read : STD_LOGIC;
    signal update_knn4_U0_Output_1_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal update_knn4_U0_Output_1_V_V_write : STD_LOGIC;
    signal update_knn5_U0_ap_start : STD_LOGIC;
    signal update_knn5_U0_ap_done : STD_LOGIC;
    signal update_knn5_U0_ap_continue : STD_LOGIC;
    signal update_knn5_U0_ap_idle : STD_LOGIC;
    signal update_knn5_U0_ap_ready : STD_LOGIC;
    signal update_knn5_U0_Input_1_V_V_read : STD_LOGIC;
    signal update_knn5_U0_Output_1_V_V : STD_LOGIC_VECTOR (31 downto 0);
    signal update_knn5_U0_Output_1_V_V_ap_vld : STD_LOGIC;
    ...
    signal start_for_update_knn2_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_update_knn2_U0_full_n : STD_LOGIC;
    signal start_for_update_knn2_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_update_knn2_U0_empty_n : STD_LOGIC;
    signal start_for_update_knn3_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_update_knn3_U0_full_n : STD_LOGIC;
    signal start_for_update_knn3_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_update_knn3_U0_empty_n : STD_LOGIC;
    signal start_for_update_knn4_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_update_knn4_U0_full_n : STD_LOGIC;
    signal start_for_update_knn4_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_update_knn4_U0_empty_n : STD_LOGIC;
    signal start_for_update_knn5_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_update_knn5_U0_full_n : STD_LOGIC;
    signal start_for_update_knn5_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_update_knn5_U0_empty_n : STD_LOGIC;
    signal update_knn5_U0_start_full_n : STD_LOGIC;
    signal update_knn5_U0_start_write : STD_LOGIC;

    component update_knn1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    update_knn1_U0 : component update_knn1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    update_knn2_U0 : component update_knn2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    update_knn3_U0 : component update_knn3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    update_knn4_U0 : component update_knn4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    update_knn5_U0 : component update_knn5
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Output_1_V_V_ap_vld <= update_knn5_U0_Output_1_V_V_ap_vld;
    ap_done <= update_knn5_U0_ap_done;
    ap_idle <= (update_knn5_U0_ap_idle and update_knn4_U0_ap_idle and update_knn3_U0_ap_idle and update_knn2_U0_ap_idle and update_knn1_U0_ap_idle);
    ap_ready <= update_knn1_U0_ap_ready;
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= update_knn5_U0_ap_done;
    ap_sync_ready <= update_knn1_U0_ap_ready;
    start_for_update_knn2_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_update_knn3_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_update_knn4_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_update_knn5_U0_din <= (0=>ap_const_logic_1, others=>'-');
    update_knn1_U0_ap_continue <= ap_const_logic_1;
    update_knn1_U0_ap_start <= ap_start;
    update_knn2_U0_ap_continue <= ap_const_logic_1;
    update_knn2_U0_ap_start <= start_for_update_knn2_U0_empty_n;
    update_knn3_U0_ap_continue <= ap_const_logic_1;
    update_knn3_U0_ap_start <= start_for_update_knn3_U0_empty_n;
    update_knn4_U0_ap_continue <= ap_const_logic_1;
    update_knn4_U0_ap_start <= start_for_update_knn4_U0_empty_n;
    update_knn5_U0_ap_continue <= ap_const_logic_1;
    update_knn5_U0_ap_start <= start_for_update_knn5_U0_empty_n;
